...
Отсутствие Authenticode снижает проверяемость происхождения, но само по себе не означает наличие вредоносного кода.
...
| Windows PE | Заголовки, секции, контекстные импорты, каталог сертификатов |
...
| Запуск в sandbox | Не входит в v0.3.1 |
